...
3. **Build and Deploy Smart Contracts:(Not Necessary)**
   ...
   - Copy the contract data generated from the deployment and replace Package_ID with the PackageID found under 'Published Object' and replace USERS_ID with the ObjectID found under 'Created Objects' (ObjectType: 0x2::package::UpgradeCap) in src/backend/utils/smc_address.json.
